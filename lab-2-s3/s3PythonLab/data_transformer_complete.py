...
INPUT_BUCKET_NAME = "robert-clayton-s3-training-input-bucket"
OUTPUT_BUCKET_NAME = "robert-clayton-s3-training-output-bucket"
...
class DataTransformer:
    ...
    def upload_file_to_bucket_enhanced(self, filename, bucket, key):
        print("\nUpload a file to a S3 bucket using AES 256 server-side encryption.Download a file from a S3 bucket")
        bucket.upload_file(
